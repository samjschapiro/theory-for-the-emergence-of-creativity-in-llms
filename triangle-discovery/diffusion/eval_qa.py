...
class Evaluator:
    def __init__(self, dir_, dataset, data_dir):
        ...
        with open(os.path.join(data_dir, dataset, "edges.json"), "r", encoding='utf-8') as f:
    ...
    def get_validity_score(self, pred):
        ...
        try:
            return int(
                b in self.edges[a] and c in self.edges[b] and a in self.edges[c]
            )
        except:

...
def load_model_local(root_dir, ckpt_dir, added_tokens, device):
...
def load_model(root_dir, ckpt_dir, added_tokens, device):
    try:
        return load_model_hf(root_dir, device)
    except:
        return load_model_local(root_dir, ckpt_dir, added_tokens, device)
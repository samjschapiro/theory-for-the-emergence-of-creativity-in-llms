...
class Seq2SeqModel:
            ...
            for step, batch in enumerate(batch_iterator):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    if ((args.save_steps > 0) and (global_step % args.save_steps == 0)) or (save_step_dense>0 and global_step % save_step_dense_interval == 0 and global_step<=save_step_dense):
                            ...
                            #)  # TODO: by Chen -- do not save model.
                            ...
                            if args.evaluate_during_training:
                                ...
                                if (not self.distributed) and args.predict_during_training:
                                    self.predict(test_data, output_dir_current, skip_model_moving=True, do_sample=do_sample, temperature=temperature)
    ...
    def predict(self, pred_data, output_dir, cutoff=None, skip_model_moving=False, out_file="all_items.json", do_sample=False, temperature=None):
        """
        Performs generation.
        Params:
